...
india_map = ImageTk.PhotoImage(Image.open("india_image.jpeg"))
us_map = ImageTk.PhotoImage(Image.open("usa_image.jpeg"))
australia_map = ImageTk.PhotoImage(Image.open("aus_image.jpeg"))
japan_map = ImageTk.PhotoImage(Image.open("japan_image.jpeg"))
